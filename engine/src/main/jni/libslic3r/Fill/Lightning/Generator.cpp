...
namespace Slic3r
{
static  std::string get_svg_filename(std::string layer_nr_or_z, std::string tag = "prusa_ts")
{
...
//    const int                  infill_extruder      = region_config.infill_extruder.value;
    ...
    // Fix lightning infill divide by zero when infill line width is set to 0.
