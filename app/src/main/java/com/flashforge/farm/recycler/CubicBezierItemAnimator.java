...
public class CubicBezierItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder holder, int fromX, int fromY, int toX, int toY) {
        ...
        // End actions are handled via AnimatorListenerAdapter.onAnimationEnd instead of withEndAction,
        // since withEndAction is not called when animations are canceled.
        final ViewPropertyAnimator animation = view.animate();
    ...
    public void endAnimation(RecyclerView.ViewHolder item) {
        ...
        // Canceling the view animation will trigger the animator's end listeners
        // which will properly clean up animation state.
        view.animate().cancel();
