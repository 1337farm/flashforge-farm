...
public:
    CalibPressureAdvancePattern(
        const Calib_Params &params, const DynamicPrintConfig &config, bool is_prusa_machine, const ModelObject &object, const Vec3d &origin);
    ...
    CustomGCode::Info generate_custom_gcodes(const DynamicPrintConfig &config, bool is_prusa_machine, const ModelObject &object, const Vec3d &origin);
...
private:
    void refresh_setup(const DynamicPrintConfig &config, bool is_prusa_machine, const ModelObject &object, const Vec3d &origin);
    void _refresh_starting_point(const ModelObject &object);
    void _refresh_writer(bool is_prusa_machine, const ModelObject &object, const Vec3d &origin);
