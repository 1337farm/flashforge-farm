    ...
    SupportGeneratorLayerStorage      &layer_storage)
{
    ...
    if (! intermediate_layers.empty() && support_params.has_interfaces()) {
        ...
        // use top/bottom interface densities for smoothing.
        ...
        // regularize top and bottom interfaces with separate minimum island radii.
        auto insert_layer = [&layer_storage, smooth_supports, closing_distance, smoothing_distance, minimum_island_radius_top, minimum_island_radius_bottom](
            ...
            // regularize interfaces using the top/bottom radii.
            ...
            // apply independent smoothing to bottom vs top.
    ...
    SupportGeneratorLayerStorage      &layer_storage)
{
    ...
    if (object.has_brim()) {
        ...
        // the pattern of raft and brim are the same, thus the brim can be serpated by support raft.
    ...
    if (slicing_params.raft_layers() > 1) {
        ...
        if (columns_base != nullptr) {
            ...
            Polygons  trimming;
            // if first layer of support is intersected with object island, it must have the same function as brim unless in nobrim mode.
...
//    const coordf_t link_max_length_factor = 3.;
    ...
    tbb::parallel_for(tbb::blocked_range<size_t>(n_raft_layers, support_layers.size()),
        ...
        for (size_t support_layer_id = range.begin(); support_layer_id < range.end(); ++ support_layer_id)
        {
            ...
            // Organic tree uses projected contacts to build the interface stack; avoid extra bottom-contact extrusion.
            ...
            auto extrude_interface = [&](SupportGeneratorLayerExtruded &layer_ex, InterfaceLayerType interface_layer_type) {
                if (! layer_ex.empty() && ! layer_ex.polygons_to_extrude().empty()) {
                    ...
                    // detect bottom interface layers for density selection.
                    ...
                    // pick density based on interface type.
