...
The headless end-to-end (E2E) test suite for flashforge-farmMobile is ready. It executes headlessly on standard JVM platforms by employing Class Path Shadowing (JNI Bypass) and Android API Stubbing.
...
- [x] **JNI Bypass (Class Path Shadowing)**: Shadowed `com.flashforge.farm.slic3r.Native` class resolves natively compiled logic without loading JNI shared libraries.
