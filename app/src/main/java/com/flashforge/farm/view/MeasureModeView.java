...
public class MeasureModeView extends FrameLayout {
    ...
    private final Bus.Listener<MeasurePointsChangedEvent> onMeasurePointsChanged = e -> updateValues(e.pointA, e.pointB);
    ...
    protected void onAttachedToWindow() {
        ...
        Bus.MEASURE_POINTS_CHANGED.observeForever(onMeasurePointsChanged);
    }

    @Override
    protected void onDetachedFromWindow() {
        super.onDetachedFromWindow();
        Bus.MEASURE_POINTS_CHANGED.removeObserver(onMeasurePointsChanged);
    }
}
