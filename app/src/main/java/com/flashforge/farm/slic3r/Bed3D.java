...
import com.flashforge.farm.render.CoordAxes;
...
public class Bed3D {
    ...
    private void renderTexturedBed(GLShadersManager shadersManager, boolean bottom, float[] viewModelMatrix, float[] projectionMatrix, int tex_id) {
