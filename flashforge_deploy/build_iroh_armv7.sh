...
echo ""
echo "Next Steps:"
echo "1. Copy '$OUTPUT_DIR/iroh' (and iroh_key.priv) to a FAT32 USB drive."
echo "2. Run 'flashforge_deploy/flashforge_init.sh' on the printer to deploy."
echo "3. Verify on the printer with: sha256sum /usr/data/iroh_farm/iroh"
echo "   Expected SHA-256: $HASH"
echo "============================================================"
exit 0
