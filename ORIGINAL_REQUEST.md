...
Overhaul the flashforge-farmMobile Android application to include advanced desktop-level features such as 3D measuring, color/support painting, long-press context menus, an optimized "fill bed" algorithm, a first-time setup screen, and resolve remaining PrusaSlicer to flashforge-farm nomenclature bugs.

Working directory: /home/cody/workspace/flashforge-farmMobile
Integrity mode: development

## Requirements

### R1. 3D Renderer Features & UI
Implement color painting, support painting, and 3D measuring tools. Add a long-press context menu to the 3D model view mimicking flashforge-farm desktop's right-click menu.
