# Handoff Report: flashforge-farmMobile Multi-Color Fix & Pressure Advance Next Steps

## 1. Project Context
This is an Android port of flashforge-farm. The core engine is C++ (libslic3r) bridged via JNI in `app/src/main/jni/farm/farm_native.cpp`.
...
### Files of Interest:
- `app/src/main/jni/farm/farm_native.cpp`: Contains the `model_slice` JNI method where configuration is manipulated before slicing.
- `app/src/main/java/com/flashforge/farm/slic3r/Native.java`: JNI declarations.
