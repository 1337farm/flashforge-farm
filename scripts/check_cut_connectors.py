...
native_java = read("app/src/main/java/com/flashforge/farm/slic3r/Native.java")
model_java = read("app/src/main/java/com/flashforge/farm/slic3r/Model.java")
renderer_java = read("app/src/main/java/com/flashforge/farm/render/GLRenderer.java")
transform_java = read("app/src/main/java/com/flashforge/farm/components/bed_menu/TransformMenu.java")
farm_native = read("app/src/main/jni/farm/farm_native.cpp")
...
for needle, label in [
    ("Java_com_flashforge_farm_slic3r_Native_model_1add_1connector", "native add connector implementation"),
    ("Java_com_flashforge_farm_slic3r_Native_model_1remove_1connector", "native remove connector implementation"),
    ("Java_com_flashforge_farm_slic3r_Native_model_1clear_1connectors", "native clear connector implementation"),
    ...
    require(farm_native, needle, label)
