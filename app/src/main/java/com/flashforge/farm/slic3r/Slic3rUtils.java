...
public class Slic3rUtils {
    ...
    /**
     * Whether a process preset's layer height is printable on the given nozzle. flashforge-farm hard-fails
    ...
    /**
     * Whether a preset is compatible with the active printer, flashforge-farm-style but resilient to the
    ...
    /**
     * flashforge-farm/PrusaSlicer preset compatibility. When the explicit compatible list (e.g.
