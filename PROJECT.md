# Project: flashforge-farmMobile Overhaul
...
- **Config Sanitizer**: `FarmApp.sanitizeConfig(String configPath)` -> ensures `brim_type` value is compatible with native Slic3r validation (e.g. mapping `"auto_brim"` to valid native format or preventing configuration load abort).

## Code Layout
- Java UI: `app/src/main/java/com/flashforge/farm/`
- GL Rendering: `app/src/main/java/com/flashforge/farm/render/`
- JNI/Native: `app/src/main/jni/farm/`
