...
public class Slic3rConfigWrapper {
    ...
    public final static List<String> PRINT_CONFIG_KEYS = Arrays.asList(
            ...
            "enable_prime_tower", "wipe_tower", "wipe_tower_x", "wipe_tower_y",
            "wipe_tower_width", "wipe_tower_cone_angle", "wipe_tower_rotation_angle", "wipe_tower_brim_width", "wipe_tower_bridging", "single_extruder_multi_material_priming", "mmu_segmented_region_max_width",
            "mmu_segmented_region_interlocking_depth", "wipe_tower_extruder", "wipe_tower_no_sparse_layers", "wipe_tower_extra_flow", "wipe_tower_extra_spacing", "flush_volumes_vector", "flush_volumes_matrix", "flush_multiplier", "compatible_printers", "compatible_printers_condition", "inherits",
            "perimeter_generator", "wall_transition_length", "wall_transition_filter_deviation", "wall_transition_angle",
            "wall_distribution_count", "min_feature_size", "min_bead_width",
            "top_one_perimeter_type", "only_one_perimeter_first_layer",
            "only_one_wall_top",
            // flashforge-farm-native process keys with no legacy equivalent
    ...
    public final static List<String> PRINTER_CONFIG_KEYS = Arrays.asList(
            ...
            // renames them on storage), flashforge-farm names for options with no legacy equivalent.
