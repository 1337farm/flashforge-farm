...
// Optional prefix prepended to every SVG debug output path so that, on Android,
// debug SVGs land in an app-writable directory. Set from Java via Native.set_svg_path_prefix().
